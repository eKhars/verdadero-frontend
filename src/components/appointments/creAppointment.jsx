...
function CreAppointment() {
  ...
  const handleServiceChange = (event) => {
    ...
    setValueService(selectedService);
  };
  ...
  return (
    <div className="p-4" style={{ marginBottom: "100px" }}>
      <header className="p-4 text-white text-center">
        ...
        <h1 className="text-4xl text-orange-500 font-bold mt-2 sm:mt-2 md:mt-2 lg:mt-2 xl:mt-2">
          {barber.name}
        </h1>
      ...
      <div className="max-w-screen-md mx-auto">
        ...
        <table className="w-full border-b-2 border-orange-500 mb-4 bg-zinc-950 shadow-md rounded-lg">
          <thead>
            <tr>
              <th className="border-b-2 border-orange-500 p-3 bg-zinc-800 text-center text-white font-bold">
                Escoge la hora de tu cita:
              </th>
            </tr>
          </thead>
          <tbody>
